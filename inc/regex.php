...
class regex {
    ...
    public static $regexhrs = '(?:\*|(?:[0-1]?[0-9]|[2]?[0-3])|(?:(?:[0-1]?[0-9]|[2]?[0-3]))-(?:(?:[0-1]?[0-9]|[2]?[0-3]))|(?:(?:[0-1]?[0-9]|[2]?[0-3]))(?:,(?:(?:[0-1]?[0-9]|[2]?[0-3])))+)';

    //matches day of month 2 or 0-5 or * or 1,2 or */5
    public static $regexdom = '(?:\*|(?:[1-2]?[0-9]|[3]?[0-1])|(?:(?:[1-2]?[0-9]|[3]?[0-1]))-(?:(?:[1-2]?[0-9]|[3]?[0-1]))|(?:(?:[1-2]?[0-9]|[3]?[0-1]))(?:,(?:(?:[1-2]?[0-9]|[3]?[0-1])))+)';

    //matches month 2 or 0-5 or * or 1,2 or */5
    public static $regexmon = '(?:\*|(?:[0]?[0-9]|[1]?[0-2])|(?:(?:[0]?[0-9]|[1]?[0-2]))-(?:(?:[0]?[0-9]|[1]?[0-2]))|(?:(?:[0]?[0-9]|[1]?[0-2]))(?:,(?:(?:[0]?[0-9]|[1]?[0-2])))+)';
